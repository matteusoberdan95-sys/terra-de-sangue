# Terra Sangrada - Visao

## Frase guia

Um guerreiro de uma cultura indigena ficticia atravessa uma terra brasileira profanada, brutalizando invasores humanos e entidades corrompidas enquanto tenta recuperar os fragmentos espirituais de seu povo.

## Genero

- Hack and slash / beat 'em up 2D.
- Camera lateral com profundidade de eixo Y.
- Ritmo de arcade classico com impacto, leitura e polimento moderno.
...
- `Final Fight`: leitura de rua, pancada, hordas.
- `Streets of Rage`: ritmo, fases urbanas, chefes memoraveis.
- Jogos de plataforma/aventura dos anos 90: silhuetas fortes e fantasia fisica.
- Acabamento moderno: luz dramatica, particulas, camera com impacto, animacoes mais fluidas.

## Pilares criativos

1. **Combate com peso**: cada golpe deve parecer intencional, perigoso e satisfatorio.
...
Pode ser mantido ate o fim. Ele comunica territorio, luto, violencia e profanacao.
